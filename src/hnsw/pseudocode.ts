...
export const LISTINGS: Listing[] = [
  {
    ...
    lines: [
      { key: 'i1', indent: 0, text: 'INSERT(q, M, Mmax, Mmax0, efConstruction, mL)' },
      { key: 'i1-cap', indent: 1, text: 'cap(lc) ← Mmax0 if lc = 0; otherwise Mmax', note: 'Layer 0 usually allows more links.' },
      ...
      { key: 'i12', indent: 3, text: 'if |neighbourhood(e, lc)| > cap(lc)' },
      { key: 'i13', indent: 4, text: 'neighbourhood(e,lc) ← SELECT-NEIGHBORS(e, neighbourhood(e,lc), cap(lc), lc)' },
  ...
  },
  {
    ...
    lines: [
      ...
      { key: 'h9', indent: 2, text: 'else Wd ← Wd ∪ {e}', note: 'The distance test treats this direction as redundant; it does not guarantee an existing route.' },
      { key: 'h10', indent: 1, text: 'if keepPruned' },
      { key: 'h11', indent: 2, text: 'while |Wd| > 0 and |R| < M: e ← remove nearest from Wd; R ← R ∪ {e}' },
  ...
  },
  {
    ...
    lines: [
      { key: 'd1', indent: 0, text: 'SOFT-DELETE(x)                       ▹ this visualizer keeps links' },
      ...
      { key: 'd5-cap', indent: 2, text: 'cap(lc) ← Mmax0 if lc = 0; otherwise Mmax' },
      ...
      { key: 'd9', indent: 3, text: 'neighbourhood(e,lc) ← SELECT-NEIGHBORS(e, neighbourhood(e,lc) ∪ A, cap(lc), lc)' },
  ...
  },
  {
    ...
    lines: [
      { key: 'u1', indent: 0, text: "UPDATE-BY-REINSERT(x, q′)             ▹ broader search, more work" },
      { key: 'u2', indent: 1, text: 'HARD-DELETE(x);  INSERT(q′)' },
      { key: 'u3', indent: 0, text: "UPDATE-IN-PLACE(x, q′)               ▹ local pool, less work" },
